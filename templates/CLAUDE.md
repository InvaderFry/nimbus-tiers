...
2. **Phase 2 (Execution, local):** The user runs `./phase2.sh`, which feeds one step file at a time to Aider + local Qwen3-32B under a 15-minute wall-clock timeout. Each successful run commits one step and stops; halts produce exit code 2.
